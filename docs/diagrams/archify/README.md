...
| 图示 | 说明 | 静态预览 | JSON 源文件 |
|---|---|---|---|
| 工作区系统架构 | 展示 32 个 skills、调度层、人类决策区和产物目录 | [PNG](assets/mm-workspace-architecture.png) / [SVG 文件](assets/mm-workspace-architecture.svg) | [JSON](sources/mm-workspace-architecture.architecture.json) |
